...
export function WorkspaceMembersCard() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      // Only owners/admins may view membership — members simply don't see the card.
  ...
  function canManage(member: Member): boolean {
    ...
    // Admins may manage members/admins, but never owners.
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage who can access this workspace and their role. People join by signing in with their own
          Azure DevOps PAT; promote, demote, or remove them here.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {loading && !data ? (
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                {member.displayName ?? member.email ?? "This member"} will immediately lose access
                                to this workspace. They can rejoin by signing in again with their Azure DevOps PAT.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
