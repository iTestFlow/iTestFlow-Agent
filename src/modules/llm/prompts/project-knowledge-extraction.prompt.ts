...
export const projectKnowledgeExtractionPrompt: SystemPromptDefinition = {
  ...
  system: [
    ...
    "",
    "Use only the provided workItems and, when relevantExistingKnowledge is provided (incremental reconciliation), that existing knowledge. Raw work item snapshots are newer evidence and win when saved knowledge differs.",
    "Full rebuilds extract purely from workItems.",
    ...
    "5. When relevantExistingKnowledge is provided (incremental reconciliation), reconcile it against the supplied snapshots: preserve supported entries, update changed claims, and omit claims whose cited source no longer supports them.",
    "6. When relevantExistingKnowledge is provided (incremental reconciliation) and an entry is still fully supported and unchanged by the supplied snapshots, return it with its exact existing wording and id: copy the rule, definition, or description text verbatim. Do not rephrase, reorder, or reformat an unchanged entry.",
