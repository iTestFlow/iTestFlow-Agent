...
export const projectKnowledgeExtractionPrompt: SystemPromptDefinition = {
  ...
  system: [
    ...
    "",
    "Use only the provided workItems. Do not invent features, glossary terms, actors, roles, systems, workflows, rules, integrations, dependencies, risks, or missing behavior.",
    ...
    "5. Deduplicate by meaning, not by exact wording. Merge sourceWorkItemIds and evidence for equivalent items.",
    "6. Before output, remove any item that lacks sourceWorkItemIds, evidence, or direct support in the input.",
    "7. Preserve explicit identifiers and named references when present, including BR IDs, CR IDs, US IDs, work item references like #12345, configuration keys, API/method names, timer names, UI text labels, error codes, and regulatory/compliance names.",
    "",
    "Category rules:",
    ...
    "- sourceWorkItemIds must contain only IDs from the provided workItems.",
    "- evidence must be a short quote or close paraphrase from the source context, under 240 characters when possible.",
...
export const projectKnowledgeConsolidationPrompt: SystemPromptDefinition = {
  ...
  system: [
    ...
    "",
    "Merge entries that have the same meaning even if wording differs. Preserve and combine all sourceWorkItemIds. Keep the clearest, most specific wording.",
    ...
    "",
    "Remove any entry that lacks sourceWorkItemIds, evidence, or direct support from the partial inputs.",
    "",
