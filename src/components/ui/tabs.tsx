  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        primary: "rounded-md border border-border bg-muted p-1",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=primary]/tabs-list:data-[state=active]:bg-primary group-data-[variant=primary]/tabs-list:data-[state=active]:font-semibold group-data-[variant=primary]/tabs-list:data-[state=active]:text-primary-foreground group-data-[variant=primary]/tabs-list:data-[state=active]:shadow-sm dark:group-data-[variant=primary]/tabs-list:data-[state=active]:bg-primary dark:group-data-[variant=primary]/tabs-list:data-[state=active]:text-primary-foreground",
