...
export const GATED_INCLUDE: string[] = [
  ...
  "src/modules/test-execution/openapi-ref-resolver.ts",
  "src/modules/test-execution/database-object-manifest.ts",
  ...
  "src/modules/test-execution/execution-boundary.ts",
  "src/modules/test-execution/egress-policy.service.ts",
