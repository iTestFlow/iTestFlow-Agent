...
export const GATED_INCLUDE: string[] = [
  ...
  "src/modules/auth/enabled-providers.ts",
  ...
  "src/modules/auth/jira-token-auth.service.ts",
  ...
  "src/modules/integrations/jira-cloud/jira-http.ts",
  ...
  "src/modules/security/origin.ts",
  ...
  "src/modules/test-case-design/acceptance-criteria-contract.ts",
  "src/modules/test-case-design/acceptance-criteria-coverage.ts",
  "src/modules/test-case-design/manual-draft-token.ts",
  ...
  "src/modules/test-execution/screenshot-policy.ts",
  ...
  "src/app/api/auth/jira/login/route.ts",
  ...
  "src/app/test-execution/lib/execution-draft.ts",
  "src/app/test-execution/lib/run-payload.ts",
