...
export const GATED_INCLUDE: string[] = [
  ...
  "src/modules/integrations/browser-automation/action-tool-mapping.ts",
  "src/modules/integrations/browser-automation/aria-snapshot.ts",
  "src/modules/integrations/browser-automation/mcp-tool-allowlist.ts",
  "src/modules/integrations/browser-automation/output-scrubber.ts",
  "src/modules/integrations/api-automation/guarded-api-executor.ts",
  "src/modules/integrations/api-automation/pinned-http-transport.ts",
  "src/modules/integrations/database-automation/database-egress.ts",
  "src/modules/integrations/database-automation/database-executor.shared.ts",
  "src/modules/integrations/database-automation/sql-policy.ts",
  ...
  "src/modules/shared/sensitive-data.ts",
  ...
  "src/modules/test-execution/action-schema.ts",
  "src/modules/test-execution/agent-decision.ts",
  "src/modules/test-execution/case-capture-store.ts",
  "src/modules/test-execution/explicit-api-paths.ts",
  "src/modules/test-execution/multi-layer-action.ts",
  "src/modules/test-execution/multi-layer-step-executor.ts",
  "src/modules/test-execution/natural-plan.ts",
  "src/modules/test-execution/openapi-contract-normalizer.ts",
  "src/modules/test-execution/outcome-classifier.ts",
  "src/modules/test-execution/run-state.ts",
  "src/modules/test-execution/secret-resolution.ts",
  "src/modules/test-execution/test-execution-layer-runtime.ts",
  "src/app/api/test-execution/egress-rules/[ruleId]/route.ts",
  "src/app/api/test-execution/egress-rules/route.ts",
  "src/app/api/test-execution/integration-operations/[operationId]/route.ts",
  "src/app/api/test-execution/integration-operations/route.ts",
