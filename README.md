...
The MVP runs locally with real Azure DevOps and LLM provider APIs. Runtime configuration is initiated from the UI. `.env.local` is optional and only used as a bootstrap fallback.
...
[http://127.0.0.1:3000/configuration](http://127.0.0.1:3000/configuration)
...
1. Configure and test connections from `/configuration`.
